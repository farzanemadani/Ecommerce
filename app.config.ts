...
export default defineAppConfig({
    siteName: 'Ecommerce',
    shortDescription: 'This is an example of a EcommerceNuxt store. It provides a modern, fast, and SEO friendly ecommerce store built with Nuxt and WooCommerce.',
